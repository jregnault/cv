...
\begin{document}
    ...
    \section{Expériences}
        \cventry{Mars -- Août 2020}{Ingénieur Intelligence Artificielle (Stagiaire)}{Elosi, Villeneuve d'Ascq}{
            ...
            $\bullet$ Montée en compétence dans les modèles encodeurs / décodeurs (\textbf{deep learning})\\
    ...
    \section{Formation}
        \cventry{2017 \\--\\ 2020}{Master Informatique}{Université de Lille}{
            ...
            $\bullet$ Serveur FTP avec API \textbf{REST} (\textbf{Java})
        }
